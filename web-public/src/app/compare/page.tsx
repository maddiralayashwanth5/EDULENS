...
import { 
  Search, Plus, X, Star, Shield, MapPin, Users, 
  BookOpen, Building, Award, CheckCircle, XCircle 
} from "lucide-react";
...
const allSchools = [
  ...
  { id: "5", name: "Ryan International", location: "Pune", board: "CBSE", rating: 4.4, etiScore: 82, fees: "₹1,20,000", students: 3000, ratio: "1:25", established: 2005, facilities: ["Smart Classrooms", "Science Labs", "Library", "Sports Complex"] },
];
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Select up to 3 schools to compare them side by side and make an informed decision.
        </p>
      </div>
        ...
        {[0, 1, 2].map((index) => (
          <div key={index}>
            {selectedSchools[index] ? (
              ...
              <Dialog open={isDialogOpen && selectedSchools.length === index} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild>
                  <Card className="h-full border-dashed cursor-pointer hover:border-primary transition-colors">
                    <CardContent className="h-full min-h-[250px] flex flex-col items-center justify-center text-muted-foreground">
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Search and select a school to compare
                    </DialogDescription>
                  </DialogHeader>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-3 px-4 font-medium text-muted-foreground">Criteria</th>
                    {selectedSchools.map((school) => (
                      <th key={school.id} className="text-left py-3 px-4 font-semibold">
                        {school.name}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  ...
                  <tr className="border-b">
                    ...
                    {selectedSchools.map((school) => (
                      <td key={school.id} className="py-4 px-4 font-semibold">
                        {school.fees}
                      </td>
                    ))}
                  </tr>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-muted-foreground mb-6">
              Add schools above to start comparing them side by side
            </p>
